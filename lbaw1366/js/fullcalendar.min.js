...
(function (t, e) {
        ...
        function i(e) {
            ...
            return o && t.each(o.split(" "), function (e) {
                ...
                t.each(this.split(","), function (e, i) {
                    if ("title" == i) a.append("<span class='fc-header-title'><h2 class=\"calendar-title\">&nbsp;</h2></span>"), o && o.addClass(v + "-corner-right"), o = null;
                    else {
                        var s;
    ...
    var ke = ["Domingo", "Segunda", "Terça", "Quarta", "Quinta", "Sexta", "Sábado"],
        He = 864e5,
        Fe = 36e5,
        Re = 6e4,
        Ne = {
    ...
    Ee.dateFormatters = Ne, Ee.applyAll = I, Se.month = J, Se.basicWeek = V, Se.basicDay = U, n({
        ...
        axisFormat: "HH(:mm)pf", //add tt to am/pm
        timeFormat: {
            agenda: "HH:mm{ - HH:mm}" //hh to HH (12 to 24h format)
        },
        dragOpacity: {
            agenda: .5
        },
