...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "Sem dados a apresentar." )
		{
	 ...
	 *  @param {object} settings DataTables settings object
	 *  @param {string|int} action Paging action to take: "primeira", "primeira",
	 *    "seguinte" or "última" or page number to jump to (integer)
	...
	DataTable = function( options )
	{
		 ...
		 *  @param {string|int} mAction Paging action to take: "primeira", "primeira", "seguinte" or "última"
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oPaginate": {
				...
				/**
				 * Text to use for the 'seguinte' pagination button (to take the user to the
				 * next page).
				 *  @type string
				 *  @default Next
				 *
			 ...
			 *    } );
			 */
			"sEmptyTable": "Sem dados a apresentar.",
			 ...
			 *    } );
			 */
			"sInfo": "A mostrar _START_ a _END_ das _TOTAL_ entradas.",
			 ...
			 *    } );
			 */
			"sInfoEmpty": "A mostrar 0 entradas.",
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(Filtro de um total de _MAX_ entradas.)",
		 ...
		 *
		 * * `simple` - 'anterior' and 'seguinte' buttons only
		 * * 'simple_numbers` - 'anterior' and 'seguinte' buttons, plus page numbers
		 * * `full` - 'primeira', 'anterior', 'seguinte' and 'última' buttons
		 * * `full_numbers` - 'primeira', 'anterior', 'seguinte' and 'última' buttons, plus
		 *   page numbers
		 *  
	...
	$.extend( extPagination, {
		...
		full: function ( page, pages ) {
			return [  'primeira', 'anterior', 'seguinte', 'última' ];
		},
	
		simple_numbers: function ( page, pages ) {
			return [ 'anterior', _numbers(page, pages), 'seguinte' ];
		},
	
		full_numbers: function ( page, pages ) {
			return [ 'primeira', 'anterior', _numbers(page, pages), 'seguinte', 'última' ];
		},
